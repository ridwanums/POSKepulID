...
data class DetailPromoListItem(
    ...
    val is_active: Int,
    val is_already_redeem: Int,
    val is_non_period: Int,
    val is_pasc_merchant: Int,
    val is_redeemable: Int,
    val is_static: Int,
    val merchant_promo: MerchantPromoDetail,
    val merchants: List<MerchantDetail>,
...
data class MerchantPromoDetail(
    val created_at: String,
    val deleted_at: String,
...
data class MerchantDetail (
    val created_at: String,
    val deleted_at: String,
    val floor_maps: List<FloorMapXDetail>,
    val is_active: Int,
    val is_hot: Int,
    val is_pasc: Int,
    val merchant_address: String,
