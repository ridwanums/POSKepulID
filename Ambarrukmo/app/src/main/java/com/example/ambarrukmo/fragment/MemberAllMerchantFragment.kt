...
import com.example.ambarrukmo.databinding.FragmentMemberAllMerchantBinding
 ...
 * Use the [MemberAllMerchantFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class MemberAllMerchantFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    private var _binding : FragmentMemberAllMerchantBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMemberAllMerchantBinding.inflate(layoutInflater, container, false)
        setData()
        return binding.root
    }
    ...
    private fun setData() {
        prductViewModel.getMerchantData().observe(requireActivity()){
            when(it){
    ...
    private fun getAdapter(data: MerchantListItem) {
        val adapter = ViewAllAdater(data)
        binding.recyclerViewMemberAll.adapter = adapter
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment MemberAllMerchantFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            MemberAllMerchantFragment().apply {
