...
class LevelFloorItem : ArrayList<LevelFloorItemItem> ()

data class LevelFloorItemItem(
    ...
    val merchants: MerchantItem,
    val updated_at: String
)

class MerchantItem : ArrayList<MerchantLevelFloor> ()

data class MerchantLevelFloor(
    val created_at: String,
    val deleted_at: String,
    val floor_maps: List<FloorMapLevelFloor>,
    val is_active: Int,
    val is_hot: Int,
    val is_pasc: Int,
    val loc_code: String,
